    ...
    <table border="0" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td style="padding: 20px;">
                ...
                <h1>Dear User,</h1>
                @if ($type == 'deposit')
                    <h4 style="color: #333333;">You have a USDT deposit that has been pre-credited. Details are as
                        follows:</h4>
                @else
                    <h4 style="color: #333333;">The status of your withdrawal has been updated . You may check the
                        relevant details on the your wimbledon dashboard.</h4>
                @endif

                <br>

                <div style="display: flex;justify-content: space-between">
                    <h3 style="color: #666666;">Total {{ $type }} amount :</h3>
                    <h3>{{ $amount }} USDT</h3>
                </div>
                <div style="display: flex;justify-content: space-between">
                    <h3 style="color: #666666;"> {{ $type }} Platform :</h3>
                    <h3>{{ $platform }}</h3>
                </div>
                <div style="display: flex;justify-content: space-between">
                ...
                <div style="display: flex;justify-content: space-between">
                    <h3 style="color: #666666;"> {{ $type }} Network :</h3>
                    <h3>{{ $network }}</h3>
                </div>
                <div style="">
                    <h3 style="color: #666666;"> {{ $type }} Address : </h3>
                    <h3>{{ $address }}</h3>
                </div>
               ...
               <div>
                    @if ($type == 'deposit')
                    <p> Now you need manually deposit from your selected platform in this address ({{ $address }})
                    </p>
                @endif
               </div>
