    ...
    <table border="0" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-collapse: collapse;">
      <tr>
        <td style="padding: 20px;">
          ...
          <p style="color: #666666;">Your Verification OTP is:<b>{{$forgetCode}}</b>. </p>
      ...
      <tr>
        <td style="background-color: #f4f4f4; padding: 20px;">
          ...
          <a href="wimbeldoninvestments.com/contact" style="color: #3498db; text-decoration: none;">Contact Us</a>
        </td>
      </tr>
      <tr>
        <td style="text-align: center; padding: 20px;">
          <p style="color: #999999;">You are receiving this email because you subscribed to our newsletter. To unsubscribe, <a href="wimbledoninvestments.com/risk/disclosure" style="color: #3498db; text-decoration: none;">click here</a>.</p>
        </td>
      </tr>
    </table>
