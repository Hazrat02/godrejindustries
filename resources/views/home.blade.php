	...
	<div class="container-fluid">
		<div class="row">
			<div class="mo_banners">
				...
				<!-- <div class="left_bnrs">
					<div>
						<img src="https://www.godrejindustries.com/public/images/home/New_Banner_Item_mo_01.jpg" class="fw">
					</div>
					<div>
						<img src="https://www.godrejindustries.com/public/images/home/New_Banner_Item_mo_02.jpg" class="fw">
					</div>
					<div class="mo_tag_ttl">
						<img src="https://www.godrejindustries.com/public/images/home/New_Banner_Item_mo_03.jpg" class="fw">
						<p>Consumer <br>Products</p>
					</div>
					<div class="mo_tag_ttl_01">
						<img src="https://www.godrejindustries.com/public/images/home/New_Banner_Item_mo_04.jpg" class="fw">
						<p>Capital</p>
					</div>
				</div>
				<div class="right_bnrs">
					<div class="mo_tag_ttl_02">
						<img src="https://www.godrejindustries.com/public/images/home/New_Banner_Item_mo_05.jpg" class="fw">
						<p>Chemicals</p>
					</div>
					<div class="mo_tag_ttl_03">
						<img src="https://www.godrejindustries.com/public/images/home/New_Banner_Item_mo_06.jpg" class="fw">
						<p>Properties</p>
					</div>
					<div  class="mo_tag_ttl_04">
						<img src="https://www.godrejindustries.com/public/images/home/New_Banner_Item_mo_07.jpg" class="fw">
						<p>Agrovet</p>
					</div>
					<div>
						<img src="https://www.godrejindustries.com/public/images/home/New_Banner_Item_mo_08.jpg" class="fw">
					</div>
				</div> -->
			</div>
		</div>
		...
		<div class="row">			
			<div class="col-md-10 col-md-offset-1">
				<div class="fw desc txc">
					<p class="wow fadeInUp animated fast"><img src="https://www.godrejindustries.com/public/images/Godrej_Logo_new.png" width="200"></p>
		...
		<div class="row">
			<div class="col-md-4 col-xs-6">
				<div class="businesses_ours txc pdrt">
					<img src="https://www.godrejindustries.com/public/images/home/godrej_agrovet.jpg" class="fw" alt="Godrej Agrovet">
					<p>Godrej <br>Agrovet</p>
					<a href="https://www.godrejagrovet.com/" target="_blank" class="learnmore wow fadeInUp animated fast">Explore</a>
				</div>
			</div>
			<div class="col-md-4 col-xs-6">
				<div class="businesses_ours txc pdlft">
					<img src="https://www.godrejindustries.com/public/images/home/gcpl.jpg" class="fw" alt="Godrej Consumer Products">
					<p>Godrej <br>Consumer Products</p>
					<a href="https://www.godrejcp.com/" target="_blank" class="learnmore wow fadeInUp animated fast">Explore</a>
				</div>
			</div>
			<div class="col-md-4 col-xs-6">
				<div class="businesses_ours txc pdrt">
					<img src="https://www.godrejindustries.com/public/images/home/godrej_properties.jpg" class="fw" alt="Godrej Properties">
					<p>Godrej <br>Properties</p>
					<a href="https://www.godrejproperties.com/" target="_blank" class="learnmore wow fadeInUp animated fast">Explore</a>
				</div>
			</div>
			<div class="col-md-4 col-xs-6">
				<div class="businesses_ours txc pdlft">
					<img src="https://www.godrejindustries.com/public/images/home/godrej_chemicals.jpg" class="fw" alt="Godrej Chemicals">
					<p>Godrej <br>Chemicals</p>
					<a href="https://www.godrejchemicals.com/" target="_blank" class="learnmore wow fadeInUp animated fast">Explore</a>
				</div>
			</div>
			<div class="col-md-4 col-xs-6">
				<div class="businesses_ours txc pdrt">
					<img src="https://www.godrejindustries.com/public/images/home/godrej_investment.jpg" class="fw" alt="Godrej Investment Advisers">
					<p>Godrej <br>Fund Management</p>
					<a href="https://www.godrejfunds.com/" target="_blank" class="learnmore wow fadeInUp animated fast">Explore</a>
				</div>
			</div>
			<div class="col-md-4 col-xs-6">
				<div class="businesses_ours txc pdlft">
					<img src="https://www.godrejindustries.com/public/images/home/godrej_capitals.jpg" class="fw" alt="Godrej Capital">
					<p>Godrej <br>Capital</p>
					<a href="https://www.godrejcapital.com/" target="_blank" class="learnmore wow fadeInUp animated fast">Explore</a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="fw pr desc">
						...
						<div class="fw">
							<div class="col-md-10 col-md-offset-2">
								<h2 class="wow animated fadeInUp fast"><a href="https://www.godrejdeilab.com/" target="_blank" class="blue">Diversity</a></h2>
								<h3 class="wow fadeInUp animated fast">Diversity is the philosophy of<br>who we are as a company</h3>
								<p class="blk60 wow fadeInUp animated fast">Diversity is not just nice to do. It makes great business sense. Being more diverse helps us innovate better and grow faster.</p>
								<a href="https://www.godrejdeilab.com/" target="_blank" class="learnmore wow fadeInUp animated fast">Explore</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-xs-12">
					<div class="fw pr wow fadeIn animated">
						<div class="fw mob_videos">
							<img src="https://www.godrejindustries.com/public/images/home/Diversity_bg_banner.jpg" class="fw" alt="Diversity">
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6 visible-xs">
					<div class="fw pr desc">
						...
						<div class="fw">
							<div class="col-md-10 col-md-offset-2">
								<h2 class="wow animated fadeInUp fast"><a href="https://www.godrejindustries.com/sustainability" class="blue">Sustainability</a></h2>
								<h3 class="wow fadeInUp animated fast">Building a more inclusive and greener planet</h3>
								<p class="blk60 wow fadeInUp animated fast">For over 125 years, the Godrej Industries Group has actively championed social responsibility.</p>
								<a href="https://www.godrejindustries.com/sustainability" class="learnmore wow fadeInUp animated fast">Explore</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-xs-12">
					<div class="fw pr wow fadeIn animated">
						<div class="fw mob_videos">
							<img src="https://www.godrejindustries.com/public/images/home/Sustainability_bg_Banner.jpg" class="fw" alt="Sustainability">
						</div>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-6 visible-xs">
					<div class="fw pr desc">
						...
						<div class="fw">
							<div class="col-md-10 col-md-offset-2">
								<h2 class="wow animated fadeInUp fast"><a href="https://www.godrejcareers.com/?company=godrej_industries" class="blue">Careers</a></h2>
								<h3 class="wow fadeInUp animated fast">Passionate people make for passionate Godrejites.</h3>
								<p class="blk60 wow fadeInUp animated fast">Find out how you can grow with us.</p>
								<a href="https://www.godrejcareers.com/?company=godrej_industries" target="_blank" class="learnmore wow fadeInUp animated fast">Explore</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-xs-12">
					<div class="fw pr wow fadeIn animated">
						<div class="fw mob_videos">
							<img src="https://www.godrejindustries.com/public/images/home/Careers_bg_Banner.jpg" class="fw" alt="Careers">
						</div>
					</div>
				</div>
		...
		<div class="row pr">			
			<div class="col-md-12">
				<div class="fw desc txc wow fadeInUp animated">
					...
					<p class="blk60">We are committed to creating long-term,<br class="hidden-xs"><br class="visible-xs"> sustainable value for all our stakeholders</p>
